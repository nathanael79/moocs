        ...
        <div class="scrollbar-inner">
            ...
            <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link active" href="#navbar-dashboards1" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-dashboards1">
                                <i class="ni ni-shop text-primary"></i>
                                <span class="nav-link-text">Courses</span>
                            </a>
                            <div class="collapse show" id="navbar-dashboards1">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{url('/admin/registeredCourse')}}" class="nav-link">Registered Course</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{url('/admin/unconfirmedCourse')}}" class="nav-link">Unconfirmed Course</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{url('/admin/course-category')}}" class="nav-link">Category Course</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="#navbar-dashboards2" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-dashboards2">
                                <i class="ni ni-ungroup text-orange"></i>
                                <span class="nav-link-text">User</span>
                            </a>
                            <div class="collapse show" id="navbar-dashboards2">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{url('/admin/userStudent')}}" class="nav-link">Student</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{url('/admin/userLecturer')}}" class="nav-link">Lecturer</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{url('/admin/userAdmin')}}" class="nav-link">Administrator</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
