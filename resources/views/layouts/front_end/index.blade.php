...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{!! asset('../../skwela/css/bootstrap.css')!!}" type="text/css">
    <link rel="stylesheet" href="{!! asset('../../skwela/css/animate.css')!!}" type="text/css">
    <link rel="stylesheet" href="{!! asset('../../skwela/css/owl.carousel.min.css')!!}" type="text/css">

    <link rel="stylesheet" href="{!! asset('../../skwela/fonts/ionicons/css/ionicons.min.css')!!}" type="text/css">
    <link rel="stylesheet" href="{!! asset('../../skwela/fonts/fontawesome/css/font-awesome.min.css')!!}" type="text/css">
    <link rel="stylesheet" href="{!! asset('../../skwela/fonts/flaticon/font/flaticon.css')!!}" type="text/css">

    <!-- Theme Style -->
    <link rel="stylesheet" href="{!! asset('../../skwela/css/style.css')!!}" type="text/css">
  </head>
  <body>
    ...
    <section class="site-hero overlay" data-stellar-background-ratio="0.5" style="background-image: url({{ asset('../../skwela/images/big_image_3.jpg') }});">
      <div class="container">
        <div class="row align-items-center site-hero-inner justify-content-center">
          <div class="col-md-8 text-center">

            <div class="mb-5 element-animate">
              <h1>Belajar mudah dan menyenangkan</h1>
              <p class="lead">Dapatkan pengalaman pembelajaran baru berkonsep Massive Open Online Course's (MOOC's)</p>
              <p><a href="{{url('/register')}}" class="btn btn-primary">Buat akun gratis</a></p>
            </div>
    ...
    <section class="school-features d-flex" style="background-image:url({{asset('../../skwela/images/big_image_3.jpg')}})">
    ...
    <section class="section-cover" data-stellar-background-ratio="0.5" style="background-image:url({{asset('../../skwela/images/big_image_3.jpg')}})">
      <div class="container">
      ...
      <div class="container">
        ...
        <div class="row top-course">
          <div class="col-lg-2 col-md-4 col-sm-6 col-12">
            <a href="#" class="course">
              <img src="{{url(asset('../../skwela/images/webdesign.jpg'))}}" alt="Image placeholder">
          ...
          <div class="col-lg-2 col-md-4 col-sm-6 col-12">
            <a href="#" class="course">
              <img src="{{url(asset('../../skwela/images/wordpress.jpg'))}}" alt="Image placeholder">
          ...
          <div class="col-lg-2 col-md-4 col-sm-6 col-12">
            <a href="#" class="course">
              <img src="{{url(asset('../../skwela/images/javascript.jpg'))}}" alt="Image placeholder">
          ...
          <div class="col-lg-2 col-md-4 col-sm-6 col-12">
            <a href="#" class="course">
              <img src="{{url(asset('../../skwela/images/photoshop.jpg'))}}" alt="Image placeholder">
          ...
          <div class="col-lg-2 col-md-4 col-sm-6 col-12">
            <a href="#" class="course">
              <img src="{{url(asset('../../skwela/images/reactjs.jpg'))}}" alt="Image placeholder">
          ...
          <div class="col-lg-2 col-md-4 col-sm-6 col-12">
            <a href="#" class="course">
              <img src="{{url(asset('../../skwela/images/angularjs.jpg'))}}" alt="Image placeholder">
