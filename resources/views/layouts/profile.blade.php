    ...
    <div class="scrollbar-inner">
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link" href="profile.blade.php#navbar-dashboards" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-dashboards">
            ...
            <li class="nav-item">
              <a class="nav-link" href="profile.blade.php#navbar-examples" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-examples">
              ...
              <div class="collapse" id="navbar-examples">
                <ul class="nav nav-sm flex-column">
                  ...
                  <li class="nav-item">
                    <a href="profile.blade.php" class="nav-link">Profile</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="profile.blade.php#navbar-components" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-components">
              ...
              <div class="collapse" id="navbar-components">
                <ul class="nav nav-sm flex-column">
                  ...
                  <li class="nav-item">
                    <a href="profile.blade.php#navbar-multilevel" class="nav-link" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-multilevel">Multi level</a>
                    <div class="collapse show" id="navbar-multilevel" style="">
                      <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                          <a href="profile.blade.php#!" class="nav-link ">Third level menu</a>
                        </li>
                        <li class="nav-item">
                          <a href="profile.blade.php#!" class="nav-link ">Just another link</a>
                        </li>
                        <li class="nav-item">
                          <a href="profile.blade.php#!" class="nav-link ">One last link</a>
                        </li>
                      </ul>
                    </div>
                  </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="profile.blade.php#navbar-forms" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-forms">
            ...
            <li class="nav-item">
              <a class="nav-link" href="profile.blade.php#navbar-tables" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
            ...
            <li class="nav-item">
              <a class="nav-link" href="profile.blade.php#navbar-maps" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-maps">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav align-items-center ml-md-auto">
            ...
            <li class="nav-item d-sm-none">
              <a class="nav-link" href="profile.blade.php#" data-action="search-show" data-target="#navbar-search-main">
                <i class="ni ni-zoom-split-in"></i>
              </a>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link" href="profile.blade.php#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <div class="dropdown-menu dropdown-menu-xl dropdown-menu-right py-0 overflow-hidden">
                ...
                <div class="list-group list-group-flush">
                  <a href="profile.blade.php#!" class="list-group-item list-group-item-action">
                ...
                <!-- View all -->
                <a href="profile.blade.php#!" class="dropdown-item text-center text-primary font-weight-bold py-3">View all</a>
              </div>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link" href="profile.blade.php#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <div class="dropdown-menu dropdown-menu-lg dropdown-menu-dark bg-default dropdown-menu-right">
                <div class="row shortcuts px-4">
                  <a href="profile.blade.php#!" class="col-4 shortcut-item">
          ...
          <ul class="navbar-nav align-items-center ml-auto ml-md-0">
            <li class="nav-item dropdown">
              <a class="nav-link pr-0" href="profile.blade.php#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <ul class="list-group list-group-flush list my--3">
                <li class="list-group-item px-0">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <a href="profile.blade.php#" class="avatar rounded-circle">
            ...
            <div class="card-header">
              <div class="row align-items-center">
                ...
                <div class="col-4 text-right">
                  <a href="profile.blade.php#!" class="btn btn-sm btn-primary">Settings</a>
                </div>
              </div>
            </div>
            <div class="card-body">
