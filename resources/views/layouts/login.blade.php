    ...
    <div class="container mt--8 pb-5">
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <div class="card-footer bg-transparent pb-5">
                  <div class="text-muted text-center mt-2 mb-3"><small>Create new account</small></div>
                  <div class="btn-wrapper text-center">
                      <a href="{{url('/register')}}" class="btn btn-neutral btn-icon">
                          <span class="btn-inner--icon"><img src="../../assets/img/icons/common/github.svg"></span>
                          <span class="btn-inner--text">Student</span>
                      </a>
                      <a href="{{url('/lecturer/register')}}" class="btn btn-neutral btn-icon">
                          <span class="btn-inner--icon"><img src="../../assets/img/icons/common/google.svg"></span>
                          <span class="btn-inner--text">Lecturer</span>
                      </a>
                  </div>
              </div>
          </div>
          <div class="row mt-3">
{{--            <div class="col-6">
              <a href="login.blade.php#" class="text-light"><small>Create Lecturer account</small></a>
            </div>
            <div class="col-6 text-right">
              <a href="{{url('/register')}}" class="text-light"><small>Create Student account</small></a>
            </div>--}}
          </div>
        </div>
      </div>
